...
if (enteredUsername == correctedUsername, enteredPassword == correctedPassword1) { console.log("Login Successful"); }
if (enteredUsername2 == correctedUsername, enteredPassword == correctedPassword) { console.log("Incorect Password"); }
if (en) { console.log("Incorect Username"); } else { console.log("Login Failed"); }