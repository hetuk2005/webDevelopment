...
if (enteredUsername == correctedUsername, enteredPassword1 == correctedPassword1) { console.log("Login Successful"); }
...
console.log("enteredUsername = ", enteredUsername, enteredPassword);