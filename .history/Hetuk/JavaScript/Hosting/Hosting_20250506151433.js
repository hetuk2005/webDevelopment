...
naam = "Hetuk Vinod Patel"

naam[2] = "K" // It Will Not Do Any Changes

console.log(naam);

// Non-premitive Data Types[Mutable]

let data = ["Hetuk", "Khushi", "Farhan", "Nishad"];

data[2] = "Siraj"; // It Will Do Changes Because Of Object[], Function(), Array{}
